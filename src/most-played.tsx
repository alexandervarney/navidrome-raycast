...
import { getMostPlayed, getCoverArtUrl, getNavidromeWebUrl, type Album } from "./api";
...
export default function MostPlayedCommand() {
  ...
  return (
    <Grid isLoading={isLoading} columns={5} searchBarPlaceholder="Filter most played albums...">
      {!data || data.length === 0
        ? !isLoading && (
            <Grid.EmptyView
              icon={Icon.Music}
